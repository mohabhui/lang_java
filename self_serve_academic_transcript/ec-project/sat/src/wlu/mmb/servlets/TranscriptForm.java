...
@WebServlet("/TranscriptForm")
public class TranscriptForm extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<html>");
		out.println("<head>");
		out.println("<title>Transcript Form</title>");
...
//		request.getRequestDispatcher("navadmin.html").include(request, response);
		...
		out.print("<form action='Transcript' method='post' style='width:300px'>");
...
//		}
		...
		out.print("<div class='form-group'>");
		out.print("<label for='toEmailx'>Destination Email</label>");
		out.print("<input type='text' class='form-control' value='"+bean.getEmail()+"'  name='toEmail' id='toEmailx' placeholder='toEmail'/>");
		out.print("</div>");
...
//		------------------------------------------------------------------------------
		...
		out.print("<button type='submit' class='btn btn-primary'>Email Transcript</button>");
		out.print("</form>");
