...
public class ChangePasswordForm extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<html>");
		out.println("<head>");
		out.println("<title>Change Password and Email</title>");
		...
		out.println(".btnClass {");
				...
				out.println("left: 30%;");
				out.println("}");
				out.println("input[id=email1] {");
				out.println("background-color: yellow;");
				out.println("color: red;");
				out.println("}");
				out.println("input[id=password1] {");
				out.println("background-color: yellow;");
				out.println("color: red;");
				out.println("}");
		out.println("</style>");
...
//		request.getRequestDispatcher("navadmin.html").include(request, response);
		...
		out.print("<form action='ChangePassword' method='post' style='width:300px'>");
